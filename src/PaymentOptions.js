    ...
    return (
        <div className="payment-options">
                    ...
                    <div className="pay-options-box">
                        <div className="individual-box">
                            ...
                            <p className='pay-options-features'>
                                ...
                                <span className='pay-options-features-last-line'>&#x2713; 30-Minute Practice Interview<br></br></span>
                            </p> 
                        </div>
                    </div>
                    <div className="pay-options-box">
                        <div className="individual-box">
                            ...
                            <p className='pay-options-features'>
                                ...
                                <span className='pay-options-features-line'>&#x2713; Activities & Honors Evaluation<br></br></span>
                                <span className='pay-options-features-line'>&#x2713; Resume Evaluation<br></br></span>
                                <span className='pay-options-features-last-line pay-options-features-line-x'>&#x2715; 30-Minute Practice Interview<br></br></span>
                            </p>
                        </div>
                    </div>
                    <div className="pay-options-box">
            ...
            <div className="pay-options-next-btn-wrap">
                <Link to='/cost-calculator' className='pay-options-next-btn'>Next: Determine the Exact Price w/ Our Cost Calculator</Link>
            </div>
        </div>
    );
}
